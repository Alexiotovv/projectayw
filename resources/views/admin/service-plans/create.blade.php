...
@section('page-title', 'Nuevo Plan de Servicio')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="type" id="type_select" class="form-select" required>
                        ...
                        <option value="{{ $type }}" @selected(old('type') === $type)>{{ \Illuminate\Support\Str::headline(str_replace('-', ' ', $type)) }}</option>
                        @endforeach
                ...
                <div class="col-12">
                    ...
                    <textarea name="features" rows="6" class="form-control">{{ old('features') }}</textarea>
                </div>
                <div class="col-12">
